    ...
    <body>	
		...
		<div class="container-fluid">
			<div id="content">
				<div class="col-md-3">									
					<div class="row">
						<h5>Activities <span class='locality'></span></h5>
						<div id="activity" style="width:400px; height:250px">
							<span class='reset small' style='display: none;'> <a class='reset' href='javascript:activity_chart.filterAll();dc.redrawAll();'>Reset</a>
								| Active Filter(s): <span class='filter bg-info'></span></span>
						</div>
					</div>   
					<div class="row"> 	
						<h5>Accountable Organisations <span class='locality'></span></h5>
						<div id="acc_org">
							<span class='reset small' style='display: none;'> <a class='reset' href='javascript:accountable_org_chart.filterAll();dc.redrawAll();'>Reset</a>
								| Active Filter(s): <span class='filter bg-info'></span></span>
						</div>	
